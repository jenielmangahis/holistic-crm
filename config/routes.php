...
Router::scope('/', function ($routes) {
    ...
    Router::connect(
        '/careers/:id/:slug',
        array('controller' => 'Careers', 'action' => 'frontview'),
        array(
            'pass' => array('id', 'slug'),
            'id' => '[0-9]+',
            'slug' => '[a-zA-Z0-9_-]+'
    ...
    Router::connect(
        '/plans/:id/:slug',
        array('controller' => 'Plans', 'action' => 'frontview'),
        array(
            'pass' => array('id', 'slug'),
            'id' => '[0-9]+',
            'slug' => '[a-zA-Z0-9_-]+'
    ...
    //slug Plan Categories
    Router::connect(
        '/plan_categories/:id/:slug',
        array('controller' => 'PlanCategories', 'action' => 'frontview'),
        array(
            'pass' => array('id', 'slug'),
            'id' => '[0-9]+',
            'slug' => '[a-zA-Z0-9_-]+'
