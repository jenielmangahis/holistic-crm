...
<header class="main-header">
    ...
    <a href="<?= $base_url; ?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b><?= $this->Html->image('logo-small.png',["height"=>"40","width"=>"40"]) ?></b></span>
      <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b><?= $this->Html->image('logo.png',["height"=>"40","width"=>"182"]) ?></b></span>  
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer" style="background: #d3d3d3;">
                ...
                <div class="pull-right">
                  ...
                  <a href="<?= $base_url ?>profile/index" class="btn btn-sm btn-default btn-flat" style="font-size:11px;"><i class="fa fa-user"></i> My Profile</a>
