...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><?= $this->Html->link("<i class='fa fa-gear'></i>" . __('Leads'), ['action' => 'user_leads'],['escape' => false]) ?></li>
                    ...
                    <fieldset>        
                        ...
                        <?php
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-sm-6'>";
                                 echo $this->Form->input('source_id', ['class' => 'form-control', 'id' => 'source_id', 'label' => false, 'options' => $a_sources]);                 
                            echo " </div></div>";
                            ?>
                            <?php 
                            ...
                            echo "
                            <div class='form-group'>
                                <label for='user_name' class='col-sm-2 control-label'>" . __('Lead Entered By') . "</label>
                                <div class='col-sm-6'>";
                                echo $this->Form->input('user_name', ['type' => 'text', 'class' => 'form-control', 'readonly' => 'readonly', 'value' => $user_fullname, 'id' => 'user_name', 'label' => false]);
                            echo " </div></div>";
