...
<p>Hi,</p>
<p>A lead has been updated via our Holistic CRM. To update any details regarding this lead login here: <a href="https://www.holisticwebpresencecrm.com/leads/edit/<?= $lead['id']; ?>">http://holisticwebpresencecrm.com</a></p>
...
<tr>
	...
	<td>: 
		<?php $followup_note = str_replace("/webroot/upload/images/", "http://www.holisticwebpresencecrm.com/webroot/upload/images/", $lead['followup_action_notes']); ?>
		<?php if( $followup_notes != '' ){ ?>
			<div style="display: block; margin: 0px; padding: 10px;">
				<small>Date Posted : <?= date("Y-m-d H:i:s", strtotime($lead['created'])); ?></small><br />				
				<?= $followup_note; ?>
			</div>
		<?php } ?>
