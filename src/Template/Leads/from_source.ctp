                    ...
                    <table id="dt-users-list" class="table table-hover table-striped">
                        <thead class="thead-inverse">
                            <tr>
                                ...
                                <th><?= $this->Paginator->sort('created', __("Date Lead Entered") . "<i class='fa fa-sort pull-right'> </i>", array('escape' => false)) ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <?php if(isset($page)) { ?>
                                                        <?= $this->Form->postLink(
                                                                'Yes',
                                                                ['action' => 'delete', $lead->id, $source_id, "" . '?page='.$page],
                                ...
                                <td><?= date("d F, Y", strtotime($lead->created)); ?></td>
