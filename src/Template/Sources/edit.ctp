                ...
                <div class="box-body">
                    ...
                    <fieldset>        
                        <?php
                            ...
                            echo "
                            <div class='form-group'>
                                <label for='email' class='col-sm-2 control-label'>" . __('Enable Secondary Email Notifcation') . "</label>
                                <div class='col-sm-6'>";
                                echo $this->Form->select('enable_secondary_notification',["1" => "Yes", "0" => "No"],['class' => 'form-control', 'id' => 'enable_secondary_notification', 'label' => false]); 
                            echo " </div></div>"; 
                            echo "
                            <div class='form-group'>
