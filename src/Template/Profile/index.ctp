        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <br />
              <a href="#modal-change-avatar" data-toggle="modal" style="text-align:left;" class="btn btn-primary btn-block"><b><i class="fa fa-image"></i> Change Avatar</b></a>
              <a href="<?php echo $this->Url->build(['action' => 'edit']); ?>" style="text-align:left;" class="btn btn-primary btn-block"><b><i class="fa fa-pencil"></i> Edit Profile</b></a>
              <a href="<?php echo $this->Url->build(['action' => 'change_password']); ?>" style="text-align:left;" class="btn btn-primary btn-block"><b><i class="fa fa-lock"></i> Change Password</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
