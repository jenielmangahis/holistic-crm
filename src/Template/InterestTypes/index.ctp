        ...
        <section class="col-lg-12 ">
            <div class="box " >
                <div class="box-header">
                    <?= $this->Html->link(__('Add New Interest Type'), ['action' => 'add'], ['class' => 'btn btn-primary btn-sm', 'escape' => false]) ?>
                ...
                <div class="box-body">
                    <table id="dt-users-list" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php foreach ($interestTypes as $interestType): ?>
                                                        <tr>
                                <td class="table-actions">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" role="menu" aria-labelledby="drpdwn">
                                            <li role="presentation"><?= $this->Html->link('<i class="fa fa-eye"></i> View', ['action' => 'view', $interestType->id],['escape' => false]) ?></li>
                                            <li role="presentation"><?= $this->Html->link('<i class="fa fa-pencil"></i> Edit', ['action' => 'edit', $interestType->id],['escape' => false]) ?></li>
