<section class="content-header">
    <h1><?= __('Edit Interest Type') ?></h1>
    <ol class="breadcrumb">
        <li><?= $this->Html->link("<i class='fa fa-dashboard'></i>" . __("Home"), ['controller' => 'users', 'action' => 'dashboard'],['escape' => false]) ?></li>
        <li><?= $this->Html->link("<i class='fa fa-gear'></i>" . __('Interest Types'), ['action' => 'index'],['escape' => false]) ?></li>
    ...
    <div class="row">
        <section class="col-lg-12 ">
            <div class="box " >
                ...
                <div class="box-body">
                    <?= $this->Form->create($interestType,['id' => 'frm-default-add', 'type' => 'post', 'data-toggle' => 'validator', 'role' => 'form','class' => 'form-horizontal']) ?>
                    <fieldset>        
                        <?php
                            echo "
